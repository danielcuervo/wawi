...
func TestGetLevel(t *testing.T) {
	...
	logger := logx.NewDummy(logx.LevelOpt(logx.DebugLevel))
	assert.EqualValues(logx.DebugLevel, logger.Level())

	logger = logx.NewDummy(logx.LevelOpt(logx.InfoLevel))
	assert.EqualValues(logx.InfoLevel, logger.Level())
}
